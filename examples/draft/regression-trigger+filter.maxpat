{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 140.0, 524.0, 100.0, 22.0 ],
                    "text": "loadmess 2"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 257.0, 559.0, 100.0, 22.0 ],
                    "text": "switch 2"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 259.0, 598.0, 206.0, 28.0 ],
                    "size": 5.0
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int", "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 140.0, 555.0, 100.0, 22.0 ]
                }
            },
            {
                "box": {
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "float" ],
                                    "patching_rect": [ 50.0, 140.61392121093752, 29.5, 22.0 ],
                                    "text": "f"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 50.00000798095698, 222.61392100000003, 30.0, 30.0 ]
                                }
                            }
                        ],
                        "lines": [
                    ...
                    "patching_rect": [ 445.0, 51.0, 68.0, 22.0 ],
                    "text": "p resample"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 0,
                    "offset": [ 0.0, 0.0 ],
                    "patching_rect": [ 148.0, 807.0, 192.0, 90.0 ],
                    "viewvisibility": 1
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 445.0, 17.0, 206.0, 28.0 ],
                    "size": 5.0
                }
            },
            {
                "box": {
                    ...
                    "offset": [ -2.0, -4.0 ],
                    "outlettype": [ "", "", "" ],
                    "patching_rect": [ 445.0, 76.0, 417.0, 186.0 ],
                    "viewvisibility": 1
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 148.0, 643.0, 241.79486083984375, 145.89173889160156 ],
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 17.0, 166.0, 133.73121643066406, 116.319091796875 ],
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "", "", "", "", "" ],
                    "patching_rect": [ 17.0, 17.0, 335.9999993443489, 141.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "", "", "" ],
                    "patching_rect": [ 17.0, 319.0, 302.0, 181.0 ],
        ...
        "parameters": {
            ...
            "obj-41::obj-18::obj-20": [ "3503-port[1]", "port", 0 ],

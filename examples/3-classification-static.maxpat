...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 489.0, 666.0, 151.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1324.0, 671.0, 70.0, 22.0 ],
					"text" : "loadmess 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1075.0, 671.0, 70.0, 22.0 ],
					"text" : "loadmess 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1491.0, 671.0, 151.0, 22.0 ],
					"text" : "loadmess C74:/media/msp"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 322.0, 666.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 267.0, 721.0, 240.79486083984375, 109.320236206054688 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 271.0, 163.0, 133.731216430664062, 116.319091796875 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ -6.0, 0.0 ],
					"outlettype" : [ "", "", "", "float" ],
					"patching_rect" : [ 271.0, 13.0, 163.0, 132.566956000000005 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 1269.0, 721.0, 240.79486083984375, 109.320236206054688 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 1020.0, 721.0, 240.79486083984375, 109.320236206054688 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1020.0, 856.0, 74.0, 22.0 ],
					"text" : "mc.dac~ 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 771.0, 721.0, 240.79486083984375, 109.320236206054688 ],
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1500.5, 714.69921875, 1002.29486083984375, 714.69921875 ],
					"order" : 0,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 4 ],
					"midpoints" : [ 1500.5, 713.5078125, 1251.29486083984375, 713.5078125 ],
					"order" : 2,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 4 ],
					"midpoints" : [ 1500.5, 714.171875, 1500.29486083984375, 714.171875 ],
					"order" : 1,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 280.5, 580.82421875, 946.846145629882812, 580.82421875 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 3 ],
					"midpoints" : [ 308.0, 570.41839599609375, 1195.846145629882812, 570.41839599609375 ],
					"source" : [ "obj-8", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 3 ],
					"midpoints" : [ 335.5, 562.35980224609375, 1444.846145629882812, 562.35980224609375 ],
					"source" : [ "obj-8", 2 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-12::obj-18::obj-88" : [ "live.toggle[23]", "live.toggle", 0 ],
			"obj-12::obj-18::obj-92" : [ "live.toggle[22]", "live.toggle", 0 ],
			"obj-12::obj-22" : [ "synthScratch-out", "ScrOut", 0 ],
			...
			"obj-25::obj-22" : [ "live.gain~[6]", "ScrOut", 0 ],
			"obj-2::obj-18::obj-88" : [ "live.toggle[2]", "live.toggle", 0 ],
			"obj-2::obj-18::obj-92" : [ "live.toggle[1]", "live.toggle", 0 ],
			"obj-2::obj-22" : [ "synthScratch-out[1]", "ScrOut", 0 ],
			"obj-3::obj-18::obj-88" : [ "live.toggle[4]", "live.toggle", 0 ],
			"obj-3::obj-18::obj-92" : [ "live.toggle[3]", "live.toggle", 0 ],
			"obj-3::obj-22" : [ "synthScratch-out[2]", "ScrOut", 0 ],
			"parameterbanks" : 			{
...
,
				"obj-2::obj-22" : 				{
					"parameter_longname" : "synthScratch-out[1]"
				}
,
				"obj-3::obj-18::obj-88" : 				{
...
,
				"obj-3::obj-22" : 				{
					"parameter_longname" : "synthScratch-out[2]"
				}

{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    "comment": "gated list + sync",
                    "id": "obj-20",
                    "index": 0,
                    "maxclass": "outlet",
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 121.0, 515.0, 25.0, 25.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 311.0, 515.0, 25.0, 25.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 801.0, 367.0, 88.0, 85.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 0.0, 23.0, 128.0, 95.0 ],
                    "rangeruler": 0,
                    "rangeruler_size": 30,
                    "sampleperiod": 10.0,
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-101", 0 ],
                    "midpoints": [ 275.5, 306.94140625, 810.5, 306.94140625 ],
                    "order": 0,
                    "source": [ "obj-16", 2 ]
                }
            },
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-101", 0 ],
                    "midpoints": [ 395.5, 294.0, 810.5, 294.0 ],
                    "source": [ "obj-19", 0 ]
                }
            },
            {

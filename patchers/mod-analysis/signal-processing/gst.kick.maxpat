    ...
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 657.0, 0.0, 87.0, 33.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 624.0, 3.0, 25.0, 25.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 732.0, 305.0, 288.0, 187.0 ],
                    "presentation": 1,
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-101", 0 ],
                    "midpoints": [ 444.5, 352.5, 741.5, 352.5 ],
                    "source": [ "obj-32", 0 ]
                }
            },
            {

{
    "patcher": {
        ...
        "classnamespace": "box",
        "rect": [ 1281.0, 377.0, 1031.0, 665.0 ],
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 494.0, 397.0, 157.0, 21.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 380.0, 430.0, 50.0, 21.0 ],
                    "text": "deferlow"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 380.0, 386.0, 50.0, 21.0 ],
                    "text": "t l l"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 122.0, 320.0, 147.0, 21.0 ],
                    "text": "speedlim"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 1,
                    "patching_rect": [ 380.0, 480.0, 20.0, 19.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 280.0, 479.0, 78.0, 21.0 ],
                    "text": "print osc::out::"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 280.0, 430.0, 49.0, 21.0 ],
                    "text": "gate"
                }
            },
            {

...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 13.0, 210.0, 372.0, 141.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 675.0, 616.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 455.0, 617.0, 138.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 742.0, 466.0, 133.731216430664062, 116.319091796875 ],
					"varname" : "gst.display",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 675.0, 444.0, 49.0, 17.0 ],
					"text" : "loadmess 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 420.0, 152.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 451.0, 466.0, 243.0, 138.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 607.0, 130.0, 23.0 ],
					"text" : "RIoT sensors"
				}
...
,
					"patching_rect" : [ 13.0, 579.0, 172.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ -7.0, -5.0 ],
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 13.0, 445.0, 163.0, 132.56695556640625 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 13.0, 632.0, 196.0, 139.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 451.0, 232.0, 164.731216430664062, 140.56695556640625 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-23::obj-9" : [ "8359-id-clock", "10561-id-clock", 0 ],
			"obj-29::obj-16" : [ "live.numbox[2]", "live.numbox", 0 ],
			"obj-29::obj-25" : [ "live.text[11]", "live.text", 0 ],
			"obj-29::obj-50" : [ "live.numbox", "live.numbox", 0 ],
			"obj-29::obj-56" : [ "live.text[10]", "live.text", 0 ],
			"obj-29::obj-58" : [ "live.text[2]", "live.text[3]", 0 ],
			"obj-29::obj-59" : [ "live.numbox[1]", "live.numbox", 0 ],
			"obj-29::obj-60" : [ "live.text[9]", "live.text[3]", 0 ],
			"obj-29::obj-9" : [ "12718-id-clock", "1018-id-clock", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
...
, 			{
				...
				"bootpath" : "~/Repositories/Gestural-Sound-Toolkit/patchers/mod-interfaces/riot-comote",
				"patcherrelativepath" : "./mod-interfaces/riot-comote",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "./mod-interfaces/data-recording-playing",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "gst.scrolldisplay.maxpat",
				"bootpath" : "~/Repositories/Gestural-Sound-Toolkit/patchers/mod-interfaces/display",
				"patcherrelativepath" : "./mod-interfaces/display",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{

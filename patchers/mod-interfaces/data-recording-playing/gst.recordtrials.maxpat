{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "bang" ],
                    "patching_rect": [ 691.0, 520.0, 41.0, 20.0 ],
                    "text": "del 100"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "bang" ],
                    "patching_rect": [ 691.0, 496.0, 50.0, 20.0 ],
                    "text": "loadbang"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 691.0, 544.0, 102.0, 20.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "int" ],
                    "patching_rect": [ 947.0, 534.0, 29.5, 22.0 ],
                    "text": "!- 1"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 980.0, 536.0, 18.0, 18.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 366.0, 96.0, 18.0, 18.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1004.0, 534.0, 59.0, 22.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 385.0, 95.0, 59.0, 22.0 ],
                    "text": "no resize",
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 795.0, 534.0, 150.0, 22.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 380.0, 402.0, 110.0, 21.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 125.0, 2.0, 70.0, 19.0 ],
                    "text": "current trials",
                    "textjustification": 1
                }
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 309.0, 1.0, 56.035701116428356, 19.0 ],
                    "text": "max trials"
                }
            },
            {
            ...
            {
                "box": {
                    "annotation": "reset to track number",
                    "annotation_name": "reset to track number",
                    "fontsize": 12.0,
                    "hint": "reset to track number",
                    "id": "obj-24",
                    ...
                    "outlettype": [ "", "float" ],
                    "parameter_enable": 1,
                    "patching_rect": [ 651.9357084274291, 183.45237851142883, 50.0, 18.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 215.0, 22.0, 50.0, 18.0 ],
                    "saved_attribute_attributes": {
                        "valueof": {
                            "parameter_initial": [ 1 ],
                            "parameter_initial_enable": 1,
                            "parameter_linknames": 1,
                            "parameter_longname": "trackNum",
                            "parameter_modmode": 4,
                            "parameter_shortname": "trackNum",
                            "parameter_type": 1,
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "" ],
                    "parameter_enable": 1,
                    "patching_rect": [ 339.0, 185.0, 49.0, 17.452378511428833 ],
                    "presentation": 1,
                    "presentation_rect": [ 10.0, 22.0, 49.107143223285675, 22.0 ],
                    "saved_attribute_attributes": {
                        "valueof": {
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 62.0, 2.0, 60.0, 19.0 ],
                    "text": "auto. incr."
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 215.0, 1.0, 83.03570111642836, 19.0 ],
                    "text": "reset to track #"
                }
            },
            {
                "box": {
                    ...
                    "annotation_name": "auto increment",
                    "hint": "auto increment",
                    "id": "obj-26",
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 1,
                    "patching_rect": [ 503.935708, 183.452379, 24.0, 24.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 81.0, 22.0, 22.0, 22.0 ],
                    "saved_attribute_attributes": {
                        "valueof": {
                            ...
                            "parameter_initial_enable": 1,
                            "parameter_linknames": 1,
                            "parameter_longname": "autoIncr",
                            "parameter_mmax": 1,
                            "parameter_modmode": 0,
                            "parameter_shortname": "autoIncr",
                            "parameter_type": 2
                        }
                    },
                    "varname": "autoIncr"
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 267.0, 21.0, 23.0, 21.0 ],
                    "text": "1"
                }
            },
            {
                "box": {
                    "annotation": "max number of trials",
                    "annotation_name": "max number of trials",
                    "fontsize": 12.0,
                    "hint": "max number of trials",
                    "id": "obj-29",
                    "maxclass": "live.numbox",
                    "numinlets": 1,
                    "numoutlets": 2,
                    "outlettype": [ "", "float" ],
                    "parameter_enable": 1,
                    "patching_rect": [ 799.6499999999999, 183.45237851142883, 50.0, 18.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 309.0, 22.0, 50.0, 18.0 ],
                    "saved_attribute_attributes": {
                        "valueof": {
                            "parameter_initial": [ 10 ],
                            "parameter_initial_enable": 1,
                            "parameter_linknames": 1,
                            "parameter_longname": "maxTrials",
                            "parameter_modmode": 4,
                            "parameter_shortname": "maxTrials",
                            "parameter_type": 1,
                            "parameter_unitstyle": 0
                        }
                    },
            ...
            },
            {
                "box": {
                    ...
                    "outputviewname": 0,
                    "parameter_enable": 0,
                    "patching_rect": [ 505.0, 596.0, 493.0, 210.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 6.0, 51.0, 453.0, 182.0 ],
            ...
            {
                "box": {
                    "annotation": "each buffer is saved in a different file",
                    "annotation_name": "each buffer is saved in a different file",
                    "fontsize": 12.0,
                    "hint": "each buffer is saved in a different file",
                    "id": "obj-111",
                    "maxclass": "live.text",
                    "mode": 0,
                    "numinlets": 1,
                    ...
                    "outlettype": [ "", "" ],
                    "parameter_enable": 1,
                    "patching_rect": [ 1122.0, 507.0, 85.48335733333352, 26.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 373.0, 20.0, 85.05024468898773, 22.11055326461792 ],
                    "saved_attribute_attributes": {
                        "valueof": {
                            "parameter_enum": [ "val1", "val2" ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 504.93570842742906, 329.5, 69.0, 22.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 142.0, 22.0, 37.0, 22.0 ],
                    "saved_attribute_attributes": {
                        "bgcolor": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 3,
                    "outlettype": [ "", "", "" ],
                    "patching_rect": [ 248.0, 458.8684198856354, 244.0, 58.0 ],
                    "saved_object_attributes": {
                        "savegui": 0,
                        "verbose": 1
                    },
                    "text": "mubu.track #0-data 1 track1 @predef yes @samplerate 100 @matrixcols 4 @maxsize 600s @info gui \"interface multiwave, bounds -1. 1., colormode rainbow, shape line\""
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 555.0, 534.0, 75.0, 22.0 ],
                    "text": "removetrack"
                }
            }
        ],
        "lines": [
            ...
            },
            {
                "patchline": {
                    "color": [ 0.301839500665665, 0.065376877784729, 0.736398994922638, 1.0 ],
                    "destination": [ "obj-91", 0 ],
                    "midpoints": [ 1062.3064875954285, 573.2261892557144, 514.5, 573.2261892557144 ],
                    "source": [ "obj-36", 0 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    "color": [ 0.248465791344643, 0.459152579307556, 0.484386056661606, 1.0 ],
                    "destination": [ "obj-91", 0 ],
                    "midpoints": [ 514.4357084274291, 480.46052718162537, 514.5, 480.46052718162537 ],
                    "order": 1,
                    "source": [ "obj-84", 0 ]
                }
            },
        ...
        "parameters": {
            "obj-111": [ "live.text[12]", "live.text", 0 ],
            "obj-24": [ "trackNum", "trackNum", 0 ],
            "obj-26": [ "autoIncr", "autoIncr", 0 ],
            "obj-29": [ "maxTrials", "maxTrials", 0 ],

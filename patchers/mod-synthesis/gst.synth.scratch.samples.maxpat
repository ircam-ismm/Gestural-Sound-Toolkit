        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 10.5, 635.0, 63.0, 22.0 ],
                    "text": "allnotesoff"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 10.5, 116.0, 52.0, 22.0 ],
                    "text": "route off"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 5,
                    "outlettype": [ "", "", "", "", "" ],
                    "patching_rect": [ 818.0, 185.0, 264.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 765.0, 158.0, 72.0, 22.0 ],
                    "text": "patcherargs"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 138.0, 856.0, 25.0, 25.0 ]
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 138.38, 754.0, 60.0, 22.0 ],
                    "text": "mc.*~ 0.5"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 138.38, 789.41, 92.0, 22.0 ],
                    "text": "mc.mixdown~ 1"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "annotation": "loop soundfiles",
                    "annotation_name": "loop soundfiles",
                    "hint": "loop soundfiles",
                    "id": "obj-92",
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 44.0, 690.0, 347.0, 35.0 ],
            ...
            {
                "box": {
                    "annotation": "Speed for scratching",
                    "annotation_name": "Speed for scratching",
                    "hint": "Speed for scratching",
                    "id": "obj-166",
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 43.5, 23.0, 165.0, 30.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 1.0, 1.0, 169.0, 18.0 ],
                    "text": "Trigger/Scratch (mono/stereo)"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 10.5, 55.0, 25.0, 25.0 ]
                }
            }
        ],
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 356.5, 676.634765625, 217.5, 676.634765625 ],
                    "source": [ "obj-166", 0 ]
                }
            },
            {

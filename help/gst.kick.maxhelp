...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 493.0, 648.0, 39.0, 17.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 493.0, 627.0, 121.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 477.0, 606.0, 90.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 491.5, 423.0, 39.0, 17.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 491.5, 402.0, 121.0, 17.0 ],
					"text" : "loadmess resizetowindowrect 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 475.5, 381.0, 90.0, 17.0 ],
					"text" : "loadmess windresize 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 46.0, 603.0, 61.0, 22.0 ],
					"text" : "unpack f f"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, -5.0 ],
					"outlettype" : [ "", "int", "" ],
					"patching_rect" : [ 37.0, 640.0, 448.0, 238.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 97.5, 632.5, 46.5, 632.5 ],
					"source" : [ "obj-11", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-14::obj-4" : [ "live.button[2]", "live.button", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",

{
    "patcher": {
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 92.0, 431.0, 29.0, 22.0 ],
                                    "text": "thru"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "", "" ],
                                    "patching_rect": [ 31.0, 210.0, 80.0, 22.0 ],
                                    "text": "gate 2 1"
                                }
                            },
                            {
                                        ...
                                        "boxes": [
                                            {
                                                "box": {
                                                    ...
                                                    "numinlets": 1,
                                                    "numoutlets": 0,
                                                    "patching_rect": [ 902.0, 151.0, 80.0, 21.0 ],
                                                    "text": "s #0-bypass"
                                                }
                                            },
                                            {
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "numinlets": 1,
                                                    "numoutlets": 0,
                                                    "patching_rect": [ 9.5, 125.0, 81.0, 21.0 ],
                                                    "text": "s #0-median"
                                                }
                                            },
                                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 300.0, 419.0, 130.0, 10.0 ],
                                    "presentation": 1,
        ...
        "parameters": {
            ...
            "obj-5::obj-34": [ "live.toggle[3]", "bypass", 0 ],
            ...
            "obj-5::obj-8::obj-7": [ "bypass", "bypass", 0 ],
            "parameterbanks": {
                "0": {
                    "index": 0,
                    "name": "",

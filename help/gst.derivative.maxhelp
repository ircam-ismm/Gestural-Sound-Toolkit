{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 462.0, 233.0, 29.0, 17.0 ],
                    "text": "thru"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 379.0, 233.0, 49.0, 17.0 ],
                    "text": "loadmess 1"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 462.0, 172.0, 126.0, 17.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 497.0, 233.0, 39.0, 17.0 ],
                    "text": "deferlow"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 497.0, 212.0, 121.0, 17.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 480.0, 191.0, 90.0, 17.0 ],
        ...
        "parameters": {
            ...
            "obj-31::obj-195::obj-82": [ "scalingFactor", "framerate", 0 ],
            "obj-31::obj-195::obj-86": [ "deltaSize", "maveragewindow", 0 ],
            "obj-31::obj-5": [ "live.text[28]", "live.text", 0 ],

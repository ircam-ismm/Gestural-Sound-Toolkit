{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "patching_rect": [ 510.0, 313.0, 102.0, 26.0 ],
            ...
            },
            {
                "box": {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 1136.0, 120.0, 80.0, 21.0 ],
                                    "text": "s #0-bypass"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "", "" ],
                                    "patching_rect": [ 982.0, 63.5, 66.0, 22.0 ],
                                    "text": "route done"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 1029.0, 119.5, 111.0, 22.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 4,
                                    "outlettype": [ "", "", "", "" ],
                                    "patching_rect": [ 1029.0, 91.5, 179.0, 22.0 ],
                                    "text": "routepass bounds mode bypass"
                                }
                            },
                            {
                                "box": {
                                        ...
                                        "boxes": [
                                            {
                                                "box": {
                                                    ...
                                                    "numinlets": 1,
                                                    "numoutlets": 0,
                                                    "patching_rect": [ 785.0, 193.0, 30.0, 30.0 ]
                                                }
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "numinlets": 1,
                                                    "numoutlets": 0,
                                                    "patching_rect": [ 809.0, 124.0, 36.0, 19.0 ],
                                                    "presentation": 1,
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "numoutlets": 1,
                                                    "outlettype": [ "" ],
                                                    "patching_rect": [ 785.0, 92.0, 41.0, 22.0 ],
                                                    "text": "set $1"
                                                }
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "outlettype": [ "" ],
                                                    "parameter_enable": 1,
                                                    "patching_rect": [ 785.0, 126.0, 15.0, 15.0 ],
                                                    "presentation": 1,
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "numinlets": 1,
                                                    "numoutlets": 0,
                                                    "patching_rect": [ 734.0, 131.0, 26.0, 19.0 ],
                                                    "presentation": 1,
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "presentation": 1,
                                    "presentation_rect": [ 0.0, 39.89361673593521, 430.0, 220.0 ],
                                    "rangeruler": 0,
                                    "rangeruler_size": 30,
                                    "sampleperiod": 10.0,
                    ...
                    "patching_rect": [ 178.0, 654.0, 434.0, 264.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 70.0, 101.0, 323.0, 225.0 ],
                    "presentation": 1,
        ...
        "parameters": {
            ...
            "obj-7::obj-10::obj-32": [ "0-SclMin[3]", "SclMin-NB", 0 ],
            "obj-7::obj-10::obj-33": [ "0-SclMax[3]", "SclMax-NB", 0 ],
            ...
            "obj-7::obj-195::obj-29": [ "mode", "mode", 0 ],
            "obj-7::obj-195::obj-39": [ "bypass[1]", "bypass", 0 ],
            "obj-7::obj-2": [ "live.toggle[3]", "bypass", 0 ],

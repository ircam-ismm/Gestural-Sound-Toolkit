{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "patching_rect": [ 461.0, 121.0, 102.0, 26.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 582.5, 704.0, 29.0, 17.0 ],
                    "text": "thru"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 582.5, 670.0, 39.0, 17.0 ],
                    "text": "deferlow"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 623.5, 647.0, 121.0, 17.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 582.5, 623.0, 162.0, 19.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ -2.0, -4.0 ],
                    "outlettype": [ "", "", "" ],
                    "patching_rect": [ 68.0, 160.0, 495.0, 233.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, -3.0 ],
                    "outlettype": [ "", "", "" ],
                    "patching_rect": [ 68.0, 616.0, 499.0, 228.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 68.0, 408.0, 495.0, 195.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 99.0, 53.0, 336.0, 42.0 ],
                    "text": "gst.classification.hhmm"
                }
            },
            {
                "box": {
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 315.5, 400.5, 315.5, 400.5 ],
                    "source": [ "obj-48", 1 ]
                }
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 77.5, 400.5, 77.5, 400.5 ],
                    "source": [ "obj-48", 0 ]
                }
            }
        ],
        "parameters": {
            ...
            "obj-31::obj-5::obj-17": [ "1106-sens-type", "out-sens-type", 0 ],
            "obj-31::obj-5::obj-179": [ "1106-sens-type[1]", "in-sens-type", 0 ],
            ...
            "obj-48::obj-18": [ "live.text[13]", "live.text", 0 ],
            ...
            "obj-48::obj-6": [ "live.text[14]", "live.text", 0 ],
            "obj-48::obj-71": [ "live.toggle[1]", "live.toggle", 0 ],
            "obj-48::obj-80": [ "live.text[10]", "live.text", 0 ],
            ...
            "parameter_overrides": {
                "obj-31::obj-5::obj-17": {
                    "parameter_longname": "1106-sens-type"
                },
                "obj-31::obj-5::obj-179": {
                    "parameter_longname": "1106-sens-type[1]"
                },
                "obj-48::obj-18": {
